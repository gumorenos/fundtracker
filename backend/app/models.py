...
class Transaction(Base):
    """
    type='expense'           → PEN spend from wallet; fund_id null
    type='currency_exchange' → USD out of fund, PEN into wallet
    type='usd_expense'       → USD spend directly from fund; no PEN
    """
